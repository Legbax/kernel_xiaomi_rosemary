...
#elif LINUX_VERSION_CODE >= KERNEL_VERSION(4, 19, 0)
// 4.19+ has alloc_file_pseudo but not anon_inode_create_getfile
// Borrow kernel's anon_inode_mnt
...
#else
// Pre-4.19: no alloc_file_pseudo, use anon_inode_getfile directly
static struct vfsmount *anon_inode_mnt __read_mostly;
