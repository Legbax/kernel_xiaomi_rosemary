...
/* SC8551 ADC LSB as integer fractions (num/10000) to avoid kernel float */
#define SC8551_IBUS_ADC_LSB_NUM				15625
#define SC8551_VBUS_ADC_LSB_NUM				37500
#define SC8551_VAC_ADC_LSB_NUM				50000
#define SC8551_VOUT_ADC_LSB_NUM				12500
#define SC8551_VBAT_ADC_LSB_NUM				12555
#define SC8551_IBAT_ADC_LSB_NUM				31250
#define SC8551_TSBUS_ADC_LSB_NUM			10000
#define SC8551_TSBAT_ADC_LSB_NUM			10000
#define SC8551_TDIE_ADC_LSB_NUM				10000
#define SC8551_ADC_LSB_DENOM				10000
